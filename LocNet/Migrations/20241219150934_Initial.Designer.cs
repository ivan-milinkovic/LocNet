...
namespace LocNet.Migrations
{
    ...
    [Migration("20241219150934_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LocNet.LocDbModel.Entry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("LocNet.LocDbModel.Key", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("LocNet.LocDbModel.Locale", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("LocNet.LocDbModel.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("LocNet.LocDbModel.User", b =>
                {
            ...
            modelBuilder.Entity("LocNet.LocDbModel.Entry", b =>
                {
                    b.HasOne("LocNet.LocDbModel.Key", "Key")
                        .WithMany()
                        .HasForeignKey("KeyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LocNet.LocDbModel.Locale", "Locale")
                        .WithMany()
                        .HasForeignKey("LocaleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LocNet.LocDbModel.Project", "Project")
                        .WithMany("Entries")
            ...
            modelBuilder.Entity("ProjectUser", b =>
                {
                    b.HasOne("LocNet.LocDbModel.Project", null)
                        .WithMany()
                        .HasForeignKey("ProjectsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LocNet.LocDbModel.User", null)
                        .WithMany()
